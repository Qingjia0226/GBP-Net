...
_C.AUGMENTOR.CUTNOISE.P = 0.4
_C.AUGMENTOR.CUTNOISE.LENGTH_RATIO = 0.2
_C.AUGMENTOR.CUTNOISE.SCALE = 0.2
...
_C.AUGMENTOR.ERODE = CN({"ENABLED": True})
_C.AUGMENTOR.ERODE.P = 0.6
_C.AUGMENTOR.ERODE.SKIP = []
