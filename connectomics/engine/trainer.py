...
class Trainer(TrainerBase):
    ...
    def train(self):
        ...
        for i in range(self.total_iter_nums):
            ...
            volume,volume_l = sample.out_input, sample.out_volume
            target_l,target_s, weight = sample.out_target_l , sample.out_target_s, sample.out_weight
            ...
            self._train_misc(loss, pred_s, volume, target_s, weight,
    ...
    def test(self):
        ...
        with torch.no_grad():
            for i, sample in enumerate(self.dataloader):
                ...
                pos, ROI,out_volume = sample.pos, sample.out_input, sample.out_volume

                ROI = ROI.to(self.device, non_blocking=True)
                out_volume=out_volume.to(self.device, non_blocking=True)
                output = self.augmentor(self.model, ROI,out_volume)
